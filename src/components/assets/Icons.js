...
export const ArtistInviteSubmissionApprovedIcon = () =>
  (<SVGIcon className="ArtistInviteSubmissionApprovedIcon">
    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g stroke="#00D100" strokeWidth="1">
        <g transform="translate(6.000000, 3.000000)">
          <circle cx="6.08" cy="6.08" r="5.08" />
          <path d="M8.64615385,11.64 L3.28,11.64 L3.28,17.4876764 L5.96307692,15.5089481 L8.64615385,17.4876764 L8.64615385,11.64 Z" />
        </g>
      </g>
    </g>
  </SVGIcon>)
...
export const ArtistInviteSubmissionSelectedIcon = () =>
  (<SVGIcon className="ArtistInviteSubmissionSelectedIcon">
    <g>
      <path fill="#F4C023" d="M119.2,238.4l-21-15.8L77,238.4v-33.9H53.4v63c0,2,0.6,4,1.8,5.6c2.8,4.1,8.4,5.1,12.5,2.3
        c0.1-0.1,0.3-0.2,0.4-0.3l30.2-22.8l30,22.8c1.6,1.2,3.6,1.9,5.6,1.9c5.2-0.1,9.3-4.3,9.2-9.5c0,0,0,0,0,0v-63h-23.8V238.4z"/>
      <path fill="#F4C023" d="M198.3,98.8c-0.6-1.2-1.5-2.2-2.6-2.8l-23.6-11.9c-0.4-2.5-1.1-4.9-1.9-7.2l14.1-20.4
        c0.7-1.1,1.1-2.4,0.9-3.7c-0.2-3.2-2.9-5.7-6.1-5.5c0,0-0.1,0-0.1,0l-24.2,1.2l-4.6-4.7l1.7-24.9c0.1-1.3-0.2-2.5-0.9-3.6
        c-1.9-2.5-5.4-3-7.9-1.2l-20.1,13.5c-2.8-0.9-5.6-1.6-8.5-2.1L103.4,4.3c-0.5-1.2-1.5-2.1-2.6-2.7c-2.9-1.4-6.5-0.2-7.9,2.7
        c0,0,0,0,0,0L82.2,26.2c-2.4,0.6-4.7,1.3-7.1,2.1L56.2,15.5c-1.1-0.7-2.4-1.1-3.7-1.1c-3.3,0.3-5.7,3.1-5.4,6.4c0,0,0,0,0,0
        l1.2,24.1c-2.1,2-4.1,4.2-6,6.4l-23.6-1.5c-1.3-0.1-2.6,0.2-3.7,0.9c-2.7,1.8-3.4,5.4-1.6,8.1c0,0,0.1,0.1,0.1,0.1l14.8,21.2
        c0,1.5-0.8,3.2-1.2,4.9L4.3,96c-1.2,0.6-2.1,1.5-2.7,2.7c-1.4,3-0.2,6.5,2.7,8l23.6,11.9c-0.1,0.8-0.1,1.6,0,2.4l-15.1,22.6
        c-1.8,2.6-1.2,6.3,1.4,8.1c1.1,0.8,2.4,1.1,3.8,1l26.1-1.8c1.2,1.4,2.5,2.7,3.8,4l-1.8,25.6c-0.3,3.3,2.1,6.1,5.4,6.4c0,0,0,0,0,0
        c1.3,0,2.6-0.4,3.7-1.1l20.8-13.9c1.9,0.7,3.8,1.2,5.7,1.7l11.1,22.9c1.4,2.9,4.9,4.1,7.7,2.7c0.1,0,0.1-0.1,0.2-0.1
        c1.1-0.6,2-1.5,2.6-2.6l10.8-22.1l7.1-1.8l21.6,14.5c2.6,1.8,6.2,1.2,8.1-1.4c0,0,0.1-0.1,0.1-0.1c0.7-1.1,1-2.4,0.9-3.7
        l-1.9-26.6l2.4-2.4l27.2,1.9c3.3,0.3,6.1-2.2,6.4-5.4c0,0,0,0,0,0c0-1.3-0.4-2.6-1.1-3.7l-15-22.3c0-1.7,0.9-3.2,1.3-4.7
        l24.5-11.9c2.9-1.4,4.1-4.9,2.7-7.8C198.4,98.9,198.4,98.9,198.3,98.8z M99.9,148.8c-26.6,0-48.2-21.7-48.2-48.4
        s21.6-48.4,48.2-48.4s48.2,21.7,48.2,48.4S126.6,148.8,99.9,148.8L99.9,148.8z"/>
    </g>
  </SVGIcon>)
